...
class ervinSeeder extends Seeder
{
    /**
    ...
    {
       DB::beginTransaction();	
		$school = Schools::where('Name', 'Ervin Elementary School')->First();
		 
		$term = 'S2'; // current term
		$defaultDepartment = Departments::find(3); // default department
		
		$scheduleJson = File::get(storage_path().'/2016_spring_json/ErvinS2_SSL.json');
