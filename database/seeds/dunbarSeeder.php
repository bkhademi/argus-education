...
class dunbarSeeder extends Seeder
{
    /**
    ...
    {
		DB::beginTransaction();	
		$school = Schools::where('Name', 'Dunbar College Preparatory Academy')->First();
		 
		$term = 'S2'; // current term
		$defaultDepartment = Departments::find(2); // default department
		
		$scheduleJson = File::get(storage_path().'/2016_spring_json/DunbarS2_SSL.json');
